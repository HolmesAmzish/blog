...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="border-b-[0.5px] max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 border-black">
        <div className=" mx-auto py-16 md:py-24">
          ...
          <div className="grid grid-cols-8 grid-rows-[60px_60px_60px_60px_60px_60px] gap-[0.5px]">
            ...
            <div className="col-span-5 row-span-3 bg-white flex items-center justify-start">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tighter text-black leading-[0.85]">
            ...
            {/* Row 3: Stats col 2-4 */}
            <div className="col-span-3 bg-white flex flex-wrap content-center gap-x-4 gap-y-2">
              {statsLoading
                ? [...Array(4)].map((_, i) => (
                    <div key={i} className="flex items-center gap-2 animate-pulse">
                      <div className="h-5 w-8 bg-gray-100" />
            ...
            <div className="col-span-4 row-span-2 bg-white flex flex-col justify-between">
              ...
              <div className="flex gap-2">
                <Link
                  to="/articles"
                  className="inline-flex items-center gap-1 px-4 py-2 bg-black text-white text-[10px] font-mono uppercase tracking-wider hover:bg-[#0047FF] transition-colors duration-200"
                >
                  {t('home.readArticles')}
                ...
                <Link
                  to="/archive"
                  className="inline-flex items-center gap-1 px-4 py-2 border-[0.5px] border-black text-black text-[10px] font-mono uppercase tracking-wider hover:bg-black hover:text-white transition-colors duration-200"
                >
                  {t('home.viewArchive')}
                </Link>
              </div>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Articles grid */}
          {isLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-[0.5px] bg-gray-200 border-[0.5px] border-gray-200">
              {[...Array(3)].map((_, i) => (
                <div
                  key={i}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-[0.5px] bg-gray-200 border-[0.5px] border-gray-200">
              {latestArticles.map((article, idx) => (
                <div key={article.id} className="bg-white p-6 md:p-8">
